	...
	public static void main(String[] args) {
		...
		do {
			try {
				...
				System.out.println("${symbol_escape}n**ERROR ocurrió una excepción no esperada" + e.getMessage() + " **");
			} 

		} while (!cerrarMenu);
		System.out.println("${symbol_escape}nDesconectando, saliendo de la aplicación!");
