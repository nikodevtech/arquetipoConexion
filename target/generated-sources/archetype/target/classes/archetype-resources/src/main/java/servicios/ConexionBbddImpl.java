	...
	private String[] configuracionConexion() {
		...
		try {
			propiedadesConexionBbdd.load(new FileInputStream(new File(
					//ruta casa --> "D:${symbol_escape}${symbol_escape}Descargas${symbol_escape}${symbol_escape}DWS Java workspace${symbol_escape}${symbol_escape}ConexionPostgresqlCrudJava${symbol_escape}${symbol_escape}src${symbol_escape}${symbol_escape}util${symbol_escape}${symbol_escape}conexion_postgresql.properties"
					"C:${symbol_escape}${symbol_escape}Users${symbol_escape}${symbol_escape}Puesto9${symbol_escape}${symbol_escape}Desktop${symbol_escape}${symbol_escape}DWS Java${symbol_escape}${symbol_escape}ConexionPostgresqlCrudJava${symbol_escape}${symbol_escape}src${symbol_escape}${symbol_escape}util${symbol_escape}${symbol_escape}conexion_postgresql.properties")));
