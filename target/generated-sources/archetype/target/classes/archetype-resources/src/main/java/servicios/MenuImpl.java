...
public class MenuImpl implements MenuInterface{
	...
	public int mostrarMenu() {
		...
		return Integer.parseInt(JOptionPane.showInputDialog(
				"${symbol_escape}n--- MENU ---${symbol_escape}n" + "${symbol_escape}n1. Registrar libro${symbol_escape}n" + "2. Mostrar libro${symbol_escape}n3. Modificar libro"
						+ "${symbol_escape}n4. Eliminar libro${symbol_escape}n0. Salir${symbol_escape}n" + "${symbol_escape}nIntroduce la opción deseada: "));
